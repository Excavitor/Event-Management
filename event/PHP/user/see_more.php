...
<table class="my-4 text-center table table-hover table-borderless">
  <thead class="table-dark">
    <tr>
      ...
      <th scope="col">Address<br>(street,city,zip)</th>
      <th scope="col">Social Media Link</th>
      <th scope="col">Date<br>(from-to)</th>
    </tr>
  </thead>

  <?php
    $sql = "SELECT cid, organization_name,organization_email, organization_phone, concat_ws(', ',street, city, zip) as ads, social_media_link, concat_ws(', ',date_from, date_to) as dt
